...
const (
	...
	// DefaultClientVersion is the default version of the tofu cli.
...
// Mixin is the logic behind the tofu mixin
type Mixin struct {
...
// New tofu mixin client, initialized with useful defaults.
func New() *Mixin {
