...
const (
	...
	UserAgentOptOutEnvVar = "PORTER_TOFU_MIXIN_USER_AGENT_OPT_OUT"
)
...
func (m *Mixin) SetUserAgent() {
	// Check if PORTER_TOFU_MIXIN_USER_AGENT_OPT_OUT=true, which disables editing the user agent string
